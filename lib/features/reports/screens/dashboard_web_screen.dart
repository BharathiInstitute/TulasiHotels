...
ðŸ’° *${l10n.totalSales}:* ${Formatters.currency(data.totalSales)}
ðŸ“ *${l10n.billing}:* ${data.billCount}
ðŸ“ˆ *${l10n.averageBill}:* ${Formatters.currency(data.avgBillValue)}

ðŸ’µ ${l10n.cash}: ${Formatters.currency(data.cashAmount)} (${data.cashPercentage.toStringAsFixed(0)}%)
ðŸ“± ${l10n.upi}: ${Formatters.currency(data.upiAmount)} (${data.upiPercentage.toStringAsFixed(0)}%)
ðŸ“• ${l10n.udhar}: ${Formatters.currency(data.udharAmount)} (${data.udharPercentage.toStringAsFixed(0)}%)
