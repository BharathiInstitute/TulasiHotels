...
class ThermalPrinterService {
  ...
  /// Adds a 600 ms warm-up delay after a fresh connect.
  ...
  /// Prevents payload drops on cheap BT printer firmwares.
...
class WifiPrinterService {
  ...
  /// Send raw bytes (public, for KOT printing)
  static Future<bool> sendBytes(List<int> bytes) => _sendBytes(bytes);
...
''',
  ...
  /// Send raw bytes (public, for KOT printing)
  static Future<bool> sendBytes(String printerName, List<int> bytes) =>
