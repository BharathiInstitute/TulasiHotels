# Environment Variables Reference Ã¢â‚¬â€ Tulasi Hotels
...
| `keyAlias` | Key alias (e.g., `tulasihotels`) |
| `storeFile` | Path to `.jks` keystore file |

## GitHub Actions Secrets

Set in: GitHub Ã¢â€ â€™ Repository Settings Ã¢â€ â€™ Secrets and Variables Ã¢â€ â€™ Actions
