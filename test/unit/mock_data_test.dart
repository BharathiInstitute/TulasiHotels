/// Tests for MockData generator integrity â€” validates mock data for demos
library;

import 'package:flutter_test/flutter_test.dart';
import 'package:tulasihotels/core/data/mock_data.dart';
      ...
      for (final p in MockData.products) {
        if (p.purchasePrice != null) {
          expect(
            ...
            reason: '${p.name}: sell â‚¹${p.price} < cost â‚¹${p.purchasePrice}',
          );
        }
      }
    });
