...
// â”€â”€ Inline duplicate for KhataStats (avoid transitive import) â”€â”€
...
void main() {
  group('Integration: Khata Customer Flow', () {
    ...
    test('Step 2: Udhar bill increases balance (customer owes)', () {
      ...
      // After bill: customer balance +450 (owes â‚¹450, positive = owes)
    ...
    test('Step 3: Partial payment reduces outstanding', () {
      ...
      // Payment of â‚¹200 reduces what customer owes
    ...
    test('Step 5: Overpayment creates negative balance (advance)', () {
      ...
      // Overpayment â†’ negative balance means customer has advance
  ...
  group('Integration: Multi-udhar Bill Cycle', () {
    test('multiple udhar bills accumulate correctly', () {
      ...
      // Bill 1: â‚¹500 udhar â†’ customer owes more
      balance += 500;
      expect(balance, 500);

      // Payment: â‚¹200 â†’ reduces what customer owes
      balance -= 200;
      expect(balance, 300);
