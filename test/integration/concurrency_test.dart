...
/// â€” Bill number generation atomicity
/// â€” Batch write constraints (WriteBatch 500-op limit)
/// â€” Atomic payment + balance updates
/// â€” ID generation collision resistance
library;
...
void main() {
  group('ID generation â€” collision resistance', () {
  ...
  group('Bill number generation â€” uniqueness', () {
  ...
  group('WriteBatch size constraints (Firestore limit = 500)', () {
    ...
    test('for 10K users, batch operations stay in bounds', () {
      ...
      // Each batch has exactly â‰¤450 operations (under 500 limit)
  ...
  group('Transaction model â€” type safety for concurrent writes', () {
