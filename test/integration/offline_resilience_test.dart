...
/// â€” Empty basePath results in safe no-ops / empty returns
/// â€” Stream providers return empty lists when not authenticated
/// â€” Settings fall back to defaults when offline
/// â€” Data retention handles edge cases
library;
...
void main() {
  group('Offline resilience â€” unauthenticated state', () {
  ...
  group('Offline resilience â€” SharedPreferences defaults', () {
    setUp(() {
  ...
  group('Offline resilience â€” model fallback behavior', () {
  ...
  group('Offline resilience â€” settings persistence', () {
    setUp(() {
      SharedPreferences.setMockInitialValues({});
    });
  ...
  group('Offline resilience â€” user settings isolation on sign-out', () {
    setUp(() async {
      SharedPreferences.setMockInitialValues({
  ...
  group('Offline resilience â€” cacheProducts/cacheBills are no-ops', () {
