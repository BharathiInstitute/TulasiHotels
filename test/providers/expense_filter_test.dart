...
/// date range filtering, and sorting â€” the core logic used in billing_provider.dart
library;
...
void main() {
  ...
  group('Expense filtering logic', () {
    ...
    test('date range filter', () {
      ...
      // Note: isAfter is exclusive â€” expense on June 1 midnight is NOT after June 1 midnight
