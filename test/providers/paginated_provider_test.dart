/// Tests for PaginatedProvider â€” PaginatedState and PaginatedNotifier
///
...
import 'package:tulasihotels/core/providers/paginated_provider.dart';

void main() {
  // â”€â”€ PaginatedState â”€â”€
  ...
  group('PaginatedNotifier', () {
    ...
    test('loadMore does nothing when hasMore is false', () async {
      fetchResults = [
        (['a'], null), // Only 1 item with pageSize=2 â†’ hasMore=false
      ];
      notifier = PaginatedNotifier<String>(fetcher: mockFetcher, pageSize: 2);
      await notifier.loadInitial();
      expect(notifier.state.hasMore, isFalse);
