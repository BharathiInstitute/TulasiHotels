/// Tests for ThemeSettingsProvider â€” ThemeSettingsModel, theme mode logic
///
...
void main() {
  // â”€â”€ ThemeSettingsModel data class â”€â”€
  ...
  group('ThemeSettingsModel serialization', () {
    ...
    test('toJsonâ†’fromJson roundtrip preserves data', () {
      const original = ThemeSettingsModel(
  ...
  // â”€â”€ Theme mode determination (extracted from userThemeModeProvider) â”€â”€
