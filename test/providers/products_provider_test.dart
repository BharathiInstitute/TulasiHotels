/// Products provider â€” state management and path security tests
///
...
void main() {
  ...
  group('Products â€” model validation', () {
  ...
  group('Products â€” 10K scale warnings', () {
  ...
  group('Products â€” unit enum coverage', () {
