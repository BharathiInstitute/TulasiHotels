/// Tests for AppColors â€” color constants, semantic colors, and updatePrimary.
library;
...
void main() {
  ...
  group('AppColors â€” default values', () {
    setUp(() {
  ...
  group('AppColors â€” semantic colors', () {
  ...
  group('AppColors â€” payment colors', () {
    test('cash is green', () {
  ...
  group('AppColors â€” light mode neutrals', () {
  ...
  group('AppColors â€” dark mode neutrals', () {
