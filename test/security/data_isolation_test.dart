...
import 'package:tulasihotels/core/constants/firebase_constants.dart';
...
void main() {
  group('Data isolation â€” UID-scoped path construction', () {
  ...
  group('Data isolation â€” service boundary conditions', () {
  ...
  group('Firebase constants â€” collection names', () {
