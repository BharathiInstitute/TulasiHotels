...
void main() {
  group('AdminFirestoreService â€” primary owner protection', () {
  ...
  group('AdminStats â€” computed properties', () {
    ...
    test('mrr at 10K subscribers scale', () {
      ...
      const stats = AdminStats(
        ...
        proUsers: 2500,
        businessUsers: 500,
        mrr: 2500 * 299 + 500 * 999, // â‚¹1,247,000
      );
  ...
  group('UserSubscription â€” plan limits', () {
  ...
  group('UserLimits â€” usage tracking', () {
  ...
  group('UserActivity â€” activity tracking', () {
  ...
  group('AdminUser â€” security-relevant properties', () {
