/// Extended UserModel tests â€” newer fields, copyWith, UserSettings completeness
library;
...
void main() {
  // â”€â”€ UserModel.copyWith â€” newer fields â”€â”€
  ...
  // â”€â”€ UserSettings complete field coverage â”€â”€
  ...
  group('UserSettings complete fields', () {
    ...
    test('toMap â†’ fromMap roundtrip preserves all fields', () {
