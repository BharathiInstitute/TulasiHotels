...
///
/// Critical for 10K subscribers â€” ensures tier limits cannot be bypassed,
...
void main() {
  // â”€â”€ Subscription Plan Constants â”€â”€
  ...
  // â”€â”€ UserSubscription Model â”€â”€
  ...
  group('UserLimits', () {
    ...
    test('boundary: exactly at 80% threshold', () {
      // 40/50 = 80% exactly â€” should NOT be near limit (> 80)
  ...
  // â”€â”€ Subscription plan transitions â”€â”€

  group('Plan transitions', () {
    test('free â†’ pro increases bills limit', () {
    ...
    test('pro â†’ business increases bills limit', () {
      const pro = UserSubscription(plan: SubscriptionPlan.pro);
  ...
  // â”€â”€ Subscription enum parsing robustness â”€â”€
