/// RazorpayService â€” PaymentResult data class and completer tests
///
...
void main() {
  group('PaymentResult â€” factory constructors', () {
  ...
  group('PaymentResult â€” equality & properties', () {
  ...
  group('PaymentResult â€” amount conversion invariants', () {
    ...
    test('amount to paise conversion is correct for common amounts', () {
      ...
      for (final entry in testCases.entries) {
        ...
        expect(
          paise,
          entry.value,
          reason: 'â‚¹${entry.key} should be ${entry.value} paise',
        );
      }
    });
  ...
  group('PaymentResult â€” error classification', () {
