/// NotificationModel â€” extended tests
///
...
void main() {
  group('NotificationType â€” enum coverage', () {
    test('has 4 types', () {
  ...
  group('NotificationTargetType â€” enum coverage', () {
  ...
  group('NotificationModel â€” constructor', () {
  ...
  group('NotificationModel â€” copyWith', () {
  ...
  group('NotificationModel â€” toFirestore', () {
  ...
  group('NotificationModel â€” toUserNotification', () {
  ...
  group('NotificationModel â€” batch invariants (10K scale)', () {
    test('sendToSelectedUsers batches at 450 to stay under 500 limit', () {
      ...
      expect(numBatches, 23); // 10000/450 = 22.2 â†’ 23 batches
    });
  });
}
