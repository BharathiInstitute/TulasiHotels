/// OfflineStorageService â€” settings & printer storage tests
///
/// Tests the SharedPreferences-based settings layer of OfflineStorageService:
/// â€” SettingsKeys constants
/// â€” HiveBoxes collection name mapping
/// â€” PrinterStorage read/write with SharedPreferences
/// â€” Settings CRUD (getSetting, saveSetting, etc.)
/// â€” Usage metrics logging via SharedPreferences
library;
...
void main() {
  group('SettingsKeys â€” constant correctness', () {
  ...
  group('HiveBoxes â€” collection name mapping', () {
  ...
  group('PrinterStorage â€” SharedPreferences keys', () {
  ...
  group('PrinterStorage â€” SharedPreferences operations', () {
    setUp(() {
  ...
  group('PrinterStorage â€” edge cases', () {
    ...
    test('saving unicode receipt footer works', () async {
      SharedPreferences.setMockInitialValues({});
      await PrinterStorage.initialize();
      await PrinterStorage.saveReceiptFooter('à¤§à¤¨à¥à¤¯à¤µà¤¾à¤¦! ðŸ™');
      expect(PrinterStorage.getReceiptFooter(), 'à¤§à¤¨à¥à¤¯à¤µà¤¾à¤¦! ðŸ™');
    });
  });
}
