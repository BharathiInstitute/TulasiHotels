/// Tests for Notification system Ã¢â‚¬â€ model, enums, serialization, and platform guards
library;
...
void main() {
  ...
  group('NotificationModel.toFirestore', () {
    test('serializes required fields correctly', () {
      ...
      expect(map['body'], 'Total: Ã¢â€šÂ¹15,000');
      expect(map['type'], 'system');
      expect(map['targetType'], 'all');
      expect(map['sentBy'], 'auto');
      // createdAt uses FieldValue.serverTimestamp() Ã¢â‚¬â€ can't compare directly
  ...
  group('Edge cases', () {
    ...
    test('special characters in title and body', () {
      final model = NotificationModel(
        id: 'n1',
        title: 'Price: Ã¢â€šÂ¹500 Ã¢â‚¬â€ 20% off!',
      ...
      expect(model.title, 'Price: Ã¢â€šÂ¹500 Ã¢â‚¬â€ 20% off!');
  ...
  group('WindowsNotificationService platform safety', () {
    test('appName and appUserModelId are correct constants', () {
      ...
      const appName = 'Tulasi Hotels';
      const appUserModelId = 'TulasiERP.TulasiStores';

      expect(appName, 'Tulasi Hotels');
