/// Khata write service â€” demo mode logic tests
///
...
void main() {
  group('KhataWriteService â€” transaction model usage', () {
  ...
  group('KhataWriteService â€” balance arithmetic', () {
  ...
  group('KhataWriteService â€” provider invalidation', () {
