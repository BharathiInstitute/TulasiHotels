...
A) "Windows protected your PC" (Blue SmartScreen popup)
   → Click "More info"
   → Click "Run anyway"
   This is normal for new software. It is safe.

B) "Smart App Control blocked a file" (No "Run anyway" button)
   → You need to turn off Smart App Control (one time only):
...
NEED HELP?
----------
Contact: bharathiinstitute1@gmail.com
